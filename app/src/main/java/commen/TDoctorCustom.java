...
public class TDoctorCustom implements Serializable{
	...
	public void setDocotherphoto(String docotherphoto) {
	 ...
	 private Date docloginlastlogintime;

	 private String docloginlongitude;

	 private String docloginlatitude;

	 private String docloginlastloginlocation;
	...
	public Date getDocloginlastlogintime() {
		return docloginlastlogintime;
	}

	public void setDocloginlastlogintime(Date docloginlastlogintime) {
		this.docloginlastlogintime = docloginlastlogintime;
	}

	public String getDocloginlongitude() {
		return docloginlongitude;
	}

	public void setDocloginlongitude(String docloginlongitude) {
		this.docloginlongitude = docloginlongitude;
	}

	public String getDocloginlatitude() {
		return docloginlatitude;
	}

	public void setDocloginlatitude(String docloginlatitude) {
		this.docloginlatitude = docloginlatitude;
	}

	public String getDocloginlastloginlocation() {
		return docloginlastloginlocation;
	}

	public void setDocloginlastloginlocation(String docloginlastloginlocation) {
		this.docloginlastloginlocation = docloginlastloginlocation;
	}
