...
public class HttpUtils {
    ...
    private static final String SERVER_URL_LOGIN="";
    private static final String SERVER_URL_REGISTER="http://192.168.2.142:8080/internetmedical/user/adduser.do"; //用户注册接口
    ...
    private static final int LOGINFAILURE=7;
    private static final int LOGINSUCESS=8;
    ...
    public static void login(String user,final Handler handler){
        OkHttpClient okHttpClient= new OkHttpClient();
